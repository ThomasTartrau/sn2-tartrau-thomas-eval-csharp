...
namespace Geometrie.API.Tests
{
    ...
    {
        //on test le constructeur et toutes les méthodes de Point_Controller en Moq de IService<Point_DTO>
        [Fact]
        public void Point_Controller_Constructeur()
        {
            //arrange
            var service = new Mock<IService<Point_DTO>>().Object;
        ...
        {
            //arrange
            var service = new Mock<IService<Point_DTO>>();
